...
define( "RECIPIENT_NAME", "Arun Sahoo" );
define( "RECIPIENT_EMAIL", "arunsahoo0196@gmail.com" );
...
$websiteurl = isset( $_POST['websiteurl'] ) ? preg_replace( "/[^\.\-\_\@a-zA-Z0-9]/", "", $_POST['websiteurl'] ) : "";
